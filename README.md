...
What is the claim settlement ratio across individual and group insurance?
Which regions report the highest claims and settlements?
How do different insurers perform in terms of claim settlement?
...
Categories: Individual Insurance & Group Insurance
...
📦 Box Plots — Spread and outliers in claim and settlement amounts
...
🗺️ Certain regions consistently report higher claims and lower settlement ratios
🏦 Insurer-wise settlement ratios vary significantly highlighting performance gaps
✅ Overall settlement ratio improved from 2018 to 2022 across both categories
...
Data Cleaning — Handled null values, duplicates and data type corrections
Univariate Analysis — Distribution of individual variables
Bivariate Analysis — Relationships between claims, settlements, regions and insurers
Multivariate Analysis — Correlation heatmap and group comparisons
